...
<span>Category: </span><textarea style="width:265px; height:50px;" name="name"> </textarea><br>
...
<span>Bar Code : </span><input type="text" style="width:265px; height:30px;" name="bcode"><br>
